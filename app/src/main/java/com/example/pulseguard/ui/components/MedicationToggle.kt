...
fun MedicationToggle(
    ...
    val stateTaken = stringResource(R.string.cd_medication_state_taken)
    val stateNotTaken = stringResource(R.string.cd_medication_state_not_taken)

    Row(
        modifier = modifier
            .fillMaxWidth()
            .semantics(mergeDescendants = true) {
                stateDescription = if (checked) stateTaken else stateNotTaken
            },
